...
class UploadHandler
{
    ...
    function __construct($folder_path = '/files/', $options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_url' => $this->get_full_url().'/pics/'.$folder_path.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'image_versions' => array(
                ...
                */
                'thumbnail' => array(
                    ...
                    'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/thumbs/'.$folder_path.'/',
                    'upload_url' => $this->get_full_url().'/thumbs/'.$folder_path.'/',
