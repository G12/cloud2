...
$sql = 'SELECT i.path, i.keywords, a.artwork_title, a.artwork_year, a.artwork_height, a.artwork_width, a.artwork_units '
        . ' FROM IMAGES AS i INNER JOIN ARTWORKS a ON i.artwork_id = a.artwork_id'
        . ' where a.artwork_height >= 30'
		. ' AND a.artwork_width > 30'
        . ' AND a.artwork_units = "inches"'
        . ' AND (i.path LIKE "ruby/abstract/2006%" OR i.path LIKE "ruby/abstract/2007%" OR i.path LIKE "ruby/abstract/2008%" OR i.path LIKE "ruby/abstract/2009%" OR i.path LIKE "ruby/abstract/2010%" OR i.path LIKE "ruby/abstract/2011%")'
...
<h1>Larger Abstracts by Ruby Ewen</h1>
</header>
<div>
<?php
		//$page = array('fields' => '');
